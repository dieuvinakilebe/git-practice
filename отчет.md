Сначала я создала репозиторий git-practice на GitHub и скопировала! (Assets/iaA.jpg![g1](https://github.com/dieuvinakilebe/git-practice/assets/130928224/3361ecfa-4a20-4873-b857-8ff85e4d7017)
)
...
После я отредактировала файл example.txt, повторила некоторые шаги из пункта 3, переключилась обратно в основную ветку master помощью git checkout main и слила изменения из second branch в основную ветку, используя git merge и git push.(Assets/iaA.jpg)
  !(https://github.com/dieuvinakilebe/git-practice/assets/130928224/a1d15cb4-2e67-4a1b-985d-b442b5a56030)
